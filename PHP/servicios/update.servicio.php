...
if(isset($_POST['actu'])){    	{
        ...
        /* Query de actualzar*/
        $resultado = mysqli_query($conn, "UPDATE usuarios SET cedula='$usuario',rol='$rol', nombre='$nombre',clave='$clave',direccion='$direccion',telefono='$telefono' WHERE cedula='$usuario'");
	}
